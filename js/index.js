    ...
    //    console.log("mes..cita: " + mesCita);
        ...
        diaCita = parseInt(prompt("Ingrese un dia entre 1 y " + cantDia ));
            ...
            if(diaCita>=1 && diaCita<=cantDia)
            {
                ...
                alert("Su turno fue asignado satisfactoriamente para el " + diaCita + "/" + mesCita + ".Te esperamos...");
                imprimirticketturno();
            }
            else
